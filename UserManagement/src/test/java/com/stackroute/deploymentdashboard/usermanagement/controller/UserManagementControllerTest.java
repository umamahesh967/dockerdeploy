...
public class UserManagementControllerTest {
	...
	public void testgetById() throws Exception {
		...
		ResponseEntity<UserModel> responseNew = restTemplate
				.exchange(createURLWithPort("/v1.0/continousdelivery/user/1"), HttpMethod.GET, null, UserModel.class);
		assertNotNull(responseNew);
		UserModel actual = responseNew.getBody();
		System.out.println(actual);
		UserModel shouldBe = new UserModel("1", "devendra", "dk102@gmail.com", "Male", "active");
