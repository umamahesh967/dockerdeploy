...
public class ReportingServiceConsumerConfig {
    ...
    public ConsumerFactory<String, EmailCredentials> reportconsumerFactory() {
        ...
        props.put(
                ...
                "something");
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new JsonDeserializer<>(EmailCredentials.class));
    }
 
	
	
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, EmailCredentials> 
	  reportKafkaListenerContainerFactory() {
	 
	    ConcurrentKafkaListenerContainerFactory<String, EmailCredentials> factory = new ConcurrentKafkaListenerContainerFactory<>();
